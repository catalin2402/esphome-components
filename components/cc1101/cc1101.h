...
public:
  ...
  void setup() override;
  void set_spi_pins(InternalGPIOPin *clk_pin, InternalGPIOPin *miso_pin, InternalGPIOPin *mosi_pin,
                    InternalGPIOPin *cs_pin) {
    this->clk_pin_ = clk_pin->get_pin();
    this->miso_pin_ = miso_pin->get_pin();
    this->mosi_pin_ = mosi_pin->get_pin();
    this->cs_pin_ = cs_pin->get_pin();
  };
  void set_d0_pin(InternalGPIOPin *d0_pin) { this->d0_pin_ = d0_pin->get_pin(); };
